...
CREATE TABLE return_items (
    ...
    CONSTRAINT fk_return_items_orderitem FOREIGN KEY (order_item_id) REFERENCES order_items (id),
...
CREATE TABLE refunds (
    ...
    status            VARCHAR(20)   NOT NULL,
    gateway_ref       VARCHAR(80),
    CONSTRAINT fk_refunds_return FOREIGN KEY (return_request_id) REFERENCES return_requests (id),
    CONSTRAINT fk_refunds_order  FOREIGN KEY (order_id)          REFERENCES orders (id),
    CONSTRAINT ck_refunds_status CHECK (status IN ('COMPLETED', 'FAILED'))
);
